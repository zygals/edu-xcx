...
Page({
  ...
  submitSearch: function (e) {
    ...
    this.getListArticle(title);
  },
  inputConfirm: function (e) {
    var title = e.detail.value;
    this.getListArticle(title);
  },
  getListArticle: function (title) {
    var that = this;
    ...
    common.httpG(wxurl + 'article/index', { cate_article_id: cate_article_id, title: title }, function (obj) {
      that.setData({
  ...
  onReachBottom: function () {
    ...
    //console.log(schools);
    //get ads
    common.httpG(wxurl + 'article/index', { "page": page + 1, cate_article_id: cate_article_id }, function (obj) {
